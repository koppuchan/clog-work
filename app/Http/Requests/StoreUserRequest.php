...
class StoreUserRequest extends FormRequest
{
    ...
    public function withValidator($validator): void
    {
        $validator->after(function ($validator) {
            ...
            if (! empty($employeeCode)) {
                ...
                $exists = $userRepository->existsByEmployeeCodeInCompany($companyId, $employeeCode);
    ...
    protected function prepareForValidation(): void
    {
        ...
        // デバッグログ: 変換後のデータ
        $logService->info('StoreUserRequest::prepareForValidation', 'After conversion', [
        ...
        // デバッグログ: merge後の確認
        $logService->info('StoreUserRequest::prepareForValidation', 'After merge', [
